...
Version  : 0.54
Release  : 2
URL      : https://cpan.metacpan.org/authors/id/D/DA/DAVECROSS/XML-Feed-0.54.tar.gz
Source0  : https://cpan.metacpan.org/authors/id/D/DA/DAVECROSS/XML-Feed-0.54.tar.gz
...
%prep
%setup -q -n XML-Feed-0.54
cd ..
%setup -q -T -D -n XML-Feed-0.54 -b 1
mkdir -p deblicense/
mv %{_topdir}/BUILD/debian/* %{_topdir}/BUILD/XML-Feed-0.54/deblicense/
